...
map.getView().fit([-10490619.684258, -2455056.690149, 16291403.613098, 12134514.383695], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Managed Retreat Initiatives in Europe</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (359 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This dataset presents managed retreat initiatives across Europe, identified through a multilingual review of academic literature, grey literature, media sources, and background reports. Further details on the methodology and study can be found in: Wolff, C., Bade, F., & C. Kraan (submitted). Insights from managed retreat projects in Europe (2025). DOI:.. . ';
            }
